...
module.exports = {
    ...
    options: [
        {
            name: 'setup',
            description: 'Panneau de configuration des ticket.',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'name',
                ...
                {
                    name: 'category',
                    description: 'La catégorie ou les tickets seront ouvert.',
                    type: 'CHANNEL',
                ...
                {
                    name: 'custom-id',
                    description: 'l\'id unique du panel.',
                    type: 'STRING',
                    required: true
                },
                {
                    name: 'role-1',
                    description: 'Le rôle nécessaire pour visualiser le panneau de tickets.',
                    type: 'ROLE',
                    required: true
                },
                {
        ...
        {
            name: 'delete',
            description: 'Supprimer un panneau de ticket.',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'custom-id',
                    description: 'L\'id unique entré lors de la création de la catégorie',
                    type: 'STRING',
                    required: true
                }
            ]
        ...
        {
            name: 'list',
            description: 'Répertorier tous les panneaux de tickets.',
            type: 'SUB_COMMAND'
        },
        {
            name: 'send',
            description: 'Envoyer le panel de ticket.',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'channel',
                    description: 'Le salon ou envoyer le panel.',
                    type: 'CHANNEL',
